...
public class AutodeliverController {
    ...
    public Integer findResumeOpenPortByNacos(@PathVariable Long userId) { // userId: 1545132
        Integer resumePort = resumeServiceFeignClient.findResumePort(userId);
        System.out.println("resumePort:" + resumePort);
        return resumePort;
    }
}
